        ...
        <template v-if="form.projectType === 1">
          ...
          <div class="table-content table-images">
            ...
            >
              <el-image
                class="image-item"
                v-for="(item, index) in validPatientImagesList"
                :key="index"
                :src="item"
              ></el-image>
            </template>
          ...
          <div class="table-content table-images">
            ...
            >
              <el-image
                class="image-item"
                v-for="(item, index) in validMedicalConditionList"
                :key="index"
                :src="item"
              ></el-image>
            </template>
        ...
        <template v-if="form.projectType === 2">
          ...
          <div class="table-content table-images">
            ...
            >
              <el-image
                class="image-item"
                v-for="(item, index) in validProofDocumentsList"
                :key="index"
                :src="item"
              ></el-image>
            </template>
...
export default {
  ...
  computed: {
    ...mapGetters(["fundList"]),
    validMedicalConditionList() {
      return this.form.medicalConditionList.filter(
        (item) => item && item !== "undefined"
      );
    },
    validPatientImagesList() {
      return this.form.patientImagesList.filter(
        (item) => item && item !== "undefined"
      );
    },
    validProofDocumentsList() {
      return this.form.proofDocumentsList.filter(
        (item) => item && item !== "undefined"
      );
